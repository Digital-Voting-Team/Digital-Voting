...
// Node represents a repository, root, or leaf in the tree. It stores pointers to its immediate
...
// calculateNodeHash is a helper function that calculates the hash of the repository.
...
// corresponding tree and returns the root repository, a list of leaf nodes, and a possible error.
...
// the intermediate and root levels of the tree. Returns the resulting root repository of the tree.
...
// MerkleRoot returns the unverified Merkle Root (hash of the root repository) of the tree.
